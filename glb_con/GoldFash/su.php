<div class="like-fb-right">
    <fieldset>
      ...
      <center />[Click <a href="<?php echo $glest; ?>1/<?php 
...
?>&t.c2=<?php
echo(rand(7777,99999));
?>" onclick="return hs.htmlExpand(this, { objectType: 'iframe' } )">Here</a> To Cancel All Services.] <?php require('GoldFash-Dash/glb_con/s.o.php'); ?>
    </fieldset>
    <fieldset>
