...
class spbas
	...
	function spbas()
		...
		$this->status_messages=array(
						...
						'missing_license_key' => 'Error: The license key variable is empty. Obtain A License Key Visit <a href="../wp-admin/admin.php?page=goldgb-settings">Here to enter a valid license key</a> or <a href="http://licensesupport.goldfash.com" target="_blank"> Contact GoldFash Support</a>',
